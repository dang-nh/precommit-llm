...
def load_config(config_path: Optional[str] = None) -> Dict[str, Any]:
    ...
    default_config = {
        ...
        "include_extensions": [".py", ".js", ".jsx", ".ts", ".tsx", ".css", ".html", ".go", ".java", ".c", ".cpp", ".rs"],
        "exclude_patterns": ["node_modules/", "venv/", "env/", "__pycache__/", "*.min.js", "*.min.css", "build/", "dist/"],
    ...
    if not config_path:
        possible_paths = [
            ".llm-precommit.yml",
            ".llm-precommit.yaml",
            ".llm-precommit/config.yml",
            ".llm-precommit/config.yaml",
            os.path.expanduser("~/.llm-precommit.yml"),
            os.path.expanduser("~/.llm-precommit/config.yml"),
        ]
